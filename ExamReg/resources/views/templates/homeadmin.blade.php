        ...
        <div class="d-flex" id="wrapper">
            <div class="border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    <a href="home" class="list-group-item list-group-item-action" style="background-color: #f4f4f4;font-family: 'Times New Roman';color:black"><i class="fa fa-home"></i>&nbsp;&nbsp; Trang chủ</a>

                    <a href="lichthi" class="list-group-item list-group-item-action" style="background-color: #f4f4f4;font-family: 'Times New Roman';color:black"><i class="fa fa-print"></i>&nbsp;&nbsp; Lịch thi</a>

                    <a href="sinhvien" class="list-group-item list-group-item-action" style="background-color: #f4f4f4;font-family: 'Times New Roman';color:black"><i class="fa fa-print"></i>&nbsp;&nbsp; Sinh viên</a>
                    <a href="nhapdulieu" class="list-group-item list-group-item-action" style="background-color: #f4f4f4;font-family: 'Times New Roman';color:black"><i class="fa fa-file"></i>&nbsp;&nbsp; Nhập dữ liệu</a>
                    <hr>
