...
<div class="form-actions form-actions-padding-sm form-actions-padding-md form-actions-padding-lg">
    <a href="" class="btn-print-this btn btn-primary"  style="float: right;">In kết quả</a>
    <a href="pdf" class="btn btn-success"  style="float: right; margin-right:10px;margin-bottom:10px;">Xuất kết quả ra Word</a>
</div>
